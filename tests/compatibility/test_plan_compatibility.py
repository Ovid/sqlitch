...
class TestPlanFileCompatibility:
    ...
    def test_add_change_plan_format(self):
        ...
        sqlitch_lines = [line for line in sqlitch_plan.split('\n') if 'first_change' in line]
        sqitch_lines = [line for line in sqitch_plan.split('\n') if 'first_change' in line]
...
[core]
    ...
    def test_plan_with_dependencies_format(self):
        ...
        self.run_sqlitch(["add", "dependent_change", "--requires", "base_change"], cwd=sqlitch_dir)
        self.run_sqitch(["add", "dependent_change", "--requires", "base_change"], cwd=sqitch_dir)
        ...
        sqlitch_dep_line = next(line for line in sqlitch_lines if 'dependent_change' in line)
        sqitch_dep_line = next(line for line in sqitch_lines if 'dependent_change' in line)
