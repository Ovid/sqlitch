...
class SquitchCompatibilityTester:
    ...
    def run_sqlitch(self, args: List[str], cwd: Optional[Path] = None, 
    ...
    def run_sqitch(self, args: List[str], cwd: Optional[Path] = None,
                  input_text: Optional[str] = None) -> subprocess.CompletedProcess:
    ...
    def compare_outputs(self, sqlitch_result: subprocess.CompletedProcess,
                       sqitch_result: subprocess.CompletedProcess,
                       ignore_exit_code: bool = False) -> Dict[str, Any]:
...
class TestCLICompatibility:
    ...
    def test_invalid_command_error(self, compat_tester):
        ...
        assert invalid_cmd in sqlitch_result.stderr or invalid_cmd in sqlitch_result.stdout
        assert invalid_cmd in sqitch_result.stderr or invalid_cmd in sqitch_result.stdout
