...
""")
    ...
    def test_sqitch_with_i18n_messages(self):
        ...
        with patch.object(sqitch, 'user_name', None):
            ...
            name_issue = next((issue for issue in issues if "name" in issue.lower()), None)
    ...
    def test_german_locale_integration(self):
        ...
        try:
            ...
            result = getattr(i18n, '__')("Cannot find your name; run sqlitch config --user user.name \"YOUR NAME\"")
    ...
    def test_french_locale_integration(self):
        ...
        try:
            ...
            result = getattr(i18n, '__x')("Unknown engine: {engine}", engine="test_engine")
    ...
    def test_po_file_validation(self):
        ...
        for lang in ['de_DE', 'fr_FR', 'it_IT']:
            ...
            if po_file.exists():
                ...
                assert f'Language: {lang[:2]}' in content or f'Language: {lang}' in content
