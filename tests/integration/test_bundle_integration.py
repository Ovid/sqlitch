...
class TestBundleIntegration:
    ...
    def test_bundle_single_change(self, sqitch_instance, temp_project):
        ...
        change_lines = [line for line in lines if line and not line.startswith('%') and not line.startswith('#')]
    ...
    def test_bundle_handles_missing_scripts_gracefully(self, sqitch_instance, temp_project):
