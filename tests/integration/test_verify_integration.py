...
class TestVerifyIntegration:
    ...
    def test_load_plan_custom_file(self, temp_project):
        ...
        try:
            ...
            custom_plan.write_text("""%syntax-version=1.0.0
...
""")
    ...
    def test_execute_not_initialized(self, temp_project):
        ...
        try:
            ...
            with patch.object(sqitch, 'require_initialized', side_effect=SqlitchError("Not initialized")):
    ...
    def test_file_operations(self, temp_project_with_scripts):
        ...
        try:
            ...
            for change in plan.changes:
                verify_file = temp_project_with_scripts / 'verify' / f'{change.name}.sql'
