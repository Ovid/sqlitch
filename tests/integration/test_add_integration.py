...
class TestAddIntegration:
    ...
    def test_add_change_with_dependencies(self, temp_project):
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(
                cli,
                ["add", "posts", "--requires", "users", "--note", "Add posts table"],
            )
    ...
    def test_add_change_with_conflicts(self, temp_project):
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(
                cli, ["add", "new_feature", "--conflicts", "old_feature"]
            )
...
"""
            ...
            result = runner.invoke(
                cli, ["add", "custom_change", "--template-directory", str(template_dir)]
            )
    ...
    def test_add_change_without_scripts(self, temp_project):
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(cli, ["add", "no_verify", "--without", "verify"])
...
"""
    ...
    def test_add_change_multiple_notes(self, temp_project):
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(
                cli,
                ["add", "multi_note", "--note", "First line", "--note", "Second line"],
            )
