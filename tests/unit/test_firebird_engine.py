...
from sqlitch.engines.firebird import FirebirdEngine, FirebirdConnection, FirebirdRegistrySchema
...
class TestFirebirdEngine:
    ...
    def test_get_registry_version_not_found(self, mock_fdb):
        ...
        with patch.object(connection, 'execute', side_effect=Exception("Table not found")):
            version = engine._get_registry_version(connection)
