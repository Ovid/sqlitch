...
class TestUtilityFunctions:
    ...
    def test_show_operation_summary_failure(self):
        ...
        assert any("Successfully processed 2 changes before failure" in arg for arg in call_args_list)
    ...
    def test_confirm_destructive_operation_with_changes(self):
        ...
        result = confirm_destructive_operation(self.sqitch, "revert", "test_db", changes)
