...
from sqlitch.core.exceptions import (
    SqlitchError, ConfigurationError, PlanError, EngineError,
    ConnectionError, DeploymentError, ValidationError, TemplateError,
    VCSError, LockError, UserError, IOError, UsageError,
    hurl, handle_exception, format_error_message, suggest_help,
    format_validation_error, format_file_error, format_database_error
)
...
class TestSpecificErrors:
    ...
    def test_configuration_error(self):
        ...
        error = ConfigurationError("Invalid config", config_file="test.conf", config_key="core.engine")
    ...
    def test_connection_error(self):
        ...
        error = ConnectionError("Cannot connect", connection_string="postgresql://user@host/db")
    ...
    def test_deployment_error(self):
        ...
        error = DeploymentError("SQL failed", change_name="add_users", operation="deploy")
    ...
    def test_validation_error(self):
        ...
        error = ValidationError("Invalid name", field_name="change", field_value="bad name")
    ...
    def test_template_error(self):
        """Test TemplateError."""
        error = TemplateError("Missing variable", template_file="deploy.tmpl", template_var="project")
    ...
    def test_vcs_error(self):
        """Test VCSError."""
        error = VCSError("Git failed", vcs_command="git status", repository_path="/path/to/repo")
...
class TestHandleException:
    ...
    def test_handle_unexpected_error_with_sqitch(self):
        ...
        assert exit_code == 2
        mock_sqitch.vent.assert_called_once_with("sqlitch: unexpected error: Unexpected error")
...
class TestUtilityFunctions:
    ...
    def test_format_database_error(self):
        ...
        result = format_database_error("connect to", "postgresql://localhost/test", "Connection refused")
        assert result == "Cannot connect to postgresql://localhost/test: Connection refused"
