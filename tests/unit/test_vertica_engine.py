...
from sqlitch.engines.vertica import VerticaEngine, VerticaConnection, VerticaRegistrySchema
...
class TestVerticaRegistrySchema:
    ...
    def test_get_create_statements(self):
        ...
        assert any('CREATE TABLE IF NOT EXISTS sqitch.projects' in stmt for stmt in statements)
        assert any('CREATE TABLE IF NOT EXISTS sqitch.changes' in stmt for stmt in statements)
        assert any('CREATE TABLE IF NOT EXISTS sqitch.tags' in stmt for stmt in statements)
        assert any('CREATE TABLE IF NOT EXISTS sqitch.dependencies' in stmt for stmt in statements)
        assert any('CREATE TABLE IF NOT EXISTS sqitch.events' in stmt for stmt in statements)
        assert any('CREATE TABLE IF NOT EXISTS sqitch.releases' in stmt for stmt in statements)
...
class TestVerticaConnection:
    ...
    def test_execute_with_params(self, mock_vertica_connection):
        ...
        mock_cursor.execute.assert_called_once_with("SELECT * FROM table WHERE id = ?", [123])
...
class TestVerticaEngine:
    ...
    def test_init_with_vertica_python(self, mock_vertica_python, mock_target, mock_plan):
    ...
    @patch('sqlitch.engines.vertica.vertica_python')
    def test_create_connection_success(self, mock_vertica_python, mock_target, mock_plan):
    ...
    @patch('sqlitch.engines.vertica.vertica_python')
    def test_create_connection_failure(self, mock_vertica_python, mock_target, mock_plan):
    ...
    @patch('sqlitch.engines.vertica.vertica_python')
    def test_execute_sql_file(self, mock_vertica_python, mock_target, mock_plan, tmp_path):
    ...
    @patch('sqlitch.engines.vertica.vertica_python')
    def test_execute_sql_file_with_variables(self, mock_vertica_python, mock_target, mock_plan, tmp_path):
    ...
    def test_get_registry_version(self, mock_vertica_python, mock_target, mock_plan):
        ...
        mock_connection.fetchone.return_value = {'version': 1.1}  # Vertica returns float
    ...
    @patch('sqlitch.engines.vertica.vertica_python')
    def test_get_registry_version_not_found(self, mock_vertica_python, mock_target, mock_plan):
