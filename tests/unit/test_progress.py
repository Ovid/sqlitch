...
from sqlitch.utils.progress import (
    ProgressIndicator, Spinner, Dots, ProgressBar,
    progress_indicator, show_progress, StatusReporter,
...
class TestProgressIndicatorContextManager:
    ...
    def test_bar_context(self):
        ...
        with progress_indicator("Downloading", "bar", file=output, total=100) as indicator:
