...
class TestShowCommand:
    ...
    @patch('sys.stdout')
    def test_show_deploy_script(self, mock_stdout, mock_file, show_command, mock_target, sample_change):
    ...
    @patch('sys.stdout')
    def test_show_revert_script(self, mock_stdout, mock_file, show_command, mock_target, sample_change):
    ...
    @patch('sys.stdout')
    def test_show_verify_script(self, mock_stdout, mock_file, show_command, mock_target, sample_change):
    ...
    def test_show_with_target_option(self, show_command, mock_target):
        ...
        exit_code = show_command.execute(['--target', 'production', 'change', 'test_change'])
    ...
    def test_show_nonexistent_script_file(self, show_command, mock_target, sample_change):
    ...
    def test_show_script_file_is_directory(self, show_command, mock_target, sample_change):
