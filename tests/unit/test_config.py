...
""")
        ...
        with patch.object(Config, '_get_system_config_paths', return_value=[system_config]), \
             patch.object(Config, '_get_global_config_path', return_value=None), \
             patch.object(Config, '_get_local_config_paths', return_value=[local_config]):
