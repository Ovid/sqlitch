...
from sqlitch.engines.sqlite import SQLiteConnection, SQLiteEngine, SQLiteRegistrySchema
...
class TestSQLiteEngine:
    ...
    def mock_target(self, temp_db_path):
        ...
        return Target(name="test", uri=f"sqlite:{temp_db_path}", registry="sqitch")
    ...
    def test_get_registry_version_success(self, sqlite_engine):
        ...
        mock_connection.fetchone.return_value = {
            "CAST(ROUND(MAX(version), 1) AS TEXT)": "1.1"
        }
