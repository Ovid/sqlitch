...
class ShowCommand(BaseCommand):
    ...
    def execute(self, args: List[str]) -> int:
        ...
        try:
            ...
            return self._show_change_or_script(
                plan, target, object_type, object_key, exists_only
            )
    ...
    def _show_tag(self, plan, tag_key: str, exists_only: bool) -> int:
        ...
        is_id = len(tag_key) == 40 and all(
            c in "0123456789abcdef" for c in tag_key.lower()
        )
